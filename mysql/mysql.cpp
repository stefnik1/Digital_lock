...
int is_mysql(char *host, char *user, char *pass, char *db){
...
char* mysql_result_query(String query, String field){
  String res = "";
  ...
  char *r = new char[res.length()+1];
  memcpy(r, res.c_str(), res.length()+1);
  return r;
}